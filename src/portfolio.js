  ...
  data: [
    {
      ...
      skills: [
        ...
        "⚡ Building backend system, writing test",
        "⚡ Clean code",
      ],
      softwareSkills: [
        {
        ...
        },
        {
          ...
          fontAwesomeClassname: "postgresl",
          style: {
            color: "#663399",
          },
        },
    ...
    },
    {
      ...
      skills: [
        ...
        "⚡ Used to with agile tools",
        "⚡ Working with microservice system, deploy projects",
      ],
      softwareSkills: [
        {
        ...
        {
          skillName: "Bitbucket",
          fontAwesomeClassname: "bitbucket",
          style: {
            color: "#326CE5",
          },
        },
