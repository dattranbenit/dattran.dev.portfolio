...
class SoftwareSkill extends React.Component {
  words = ["postgresl", "nextjs", "springboot", "wordpress", "storybook", "MySql", "MongoDB", "vercel", "confluence", "jira", "gitlab", "slack", "microservice", "bitbucket"]
  render() {
    return (
      <div>
              ...
              return (
                ...
                >
                  <li className="software-skill-inline" name={logo.skillName}>
                    ...
                    {logo.fontAwesomeClassname === "postgresl" && <i className="devicon-postgresql-plain colored"></i>}
                    ...
                    {logo.fontAwesomeClassname === "bitbucket" && <i className="devicon-bitbucket-original colored"></i>}
                  </li>
                </OverlayTrigger>
              );
            })}
