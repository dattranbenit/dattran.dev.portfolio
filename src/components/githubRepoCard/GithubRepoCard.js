                  ...
                  <Grid item xs={12} className="text-uppercase text-dark mb-0">
                    ...
                    >
                      <div style={{ paddingRight: 5, marginTop: "20px" }}>
                        ...
                        {repo.name === "Language Confidence" && <img src={require("../../assests/images/lc.jpeg")} alt="" width={80}/>}
                        ...
                        {repo.name === "TYMLEZ" && <img src={require("../../assests/images/tyme.png")} alt="" width={50}/>}
